...
GROUPS = {
    "year": [("year-grid", "Year at a glance", "twelve months on one page"),
...
def p_index():
    groups = [
        ("Plan", [("year", "The long view"), ("month", "Monthly overview"),
...
def build_html():
    specs = [
        ...
        ("year-grid", p_year), ("quarterly", p_quarterly),
        ("goals", p_goals), ("review", p_review), ("project", p_project),
