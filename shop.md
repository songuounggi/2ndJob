...
- 그래서 **기존 구매자에게 새 파일을 주려면 Etsy 메시지에 PDF 를 첨부**한다.
  Etsy Help "How to Send Messages to Buyers": 입력창의 Upload image 아이콘으로
  `.jpg .gif .pdf .png` 최대 3개, 100MB 까지

**앞으로 파일을 교체하면:** 아래 판매 표의 "받은 파일"이 옛 판인 구매자 모두에게
새 PDF 를 메시지로 첨부해 보낸다. 보냈으면 표의 "받은 파일"에 적는다.
...
|---|---|---|---|---|---|---|
| 1 | 2026-09-23 22:39 | 브라질 | USD 10.19 (정가 16.99) | `LAUNCH40` | **v8.18** (`...-502-pages.pdf`, Etsy 표시 18.69 MB). v8.20 교체 직후에도 그대로 | 9/23 받음 |
