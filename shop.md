...
| 3 | **올리기 전** | `v8.20-undated` | `ADHD-Wellness-Planner-Undated-502-pages.pdf` (#2 와 같은 이름) | 16,517,551 | 502 | v8.20 빌드 → dedupe. 최종 확인 후 `upload/v8.20/`. GoodNotes 바둑판 렌더링 + 도트 그리드 수정 |
