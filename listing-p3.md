...
**초안이다. 사용자 확정 전.** 가격·제목·이미지는 사용자가 정한다.
...
| 안 | 정가 | 근거 |
|---|---|---|
| 초안 | **$12.99** | `product3-dated.md`: 매출 1위 날짜형 경쟁작 Manifestable 2026-2027 이 $10.99(세일 없음). 우리는 두 해 × 두 시작 요일 |
| 상품 1 과 같은 틀 | $16.99 + 런칭 세일 | 상품 1 이 이 방식. 세일 표시가 클릭률에 유리 |
