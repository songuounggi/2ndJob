...
VER = "v0.7"
DRAFT = "draft-v0.4"   # v0.3: 배지 시계방향 15도(사용자) / v0.1: 05 썸네일 3줄이 아래로 잘림, 06 아래가 비었다 / v0.2: 06 표지 네 장이 멀리서 구분 안 됨 -> 배지
...
.bdg{{position:absolute;top:-26px;right:-18px;border-radius:26px;padding:16px 26px 14px;text-align:center;color:#fff;box-shadow:0 8px 18px rgba(0,0,0,.22);transform:rotate(15deg)}}
