...
MONTHS = [
    ...
    ("Mind your mind", "A month to check in with your mind, kindly.",
...
ADMIN = [
    ["Set up this year's planner", "Review every subscription", "Book the yearly checkup", "Back up phone photos"],
    ...
    ["Mental health check-in", 'Check passport expiration', "Replace your toothbrush", "Plan time off"],
    ["Midyear money check", 'Renew what expires soon', 'Restock the first-aid kit', "Clean out the car"],
    ...
    ["Reset one room", "Check heating and filters", "Review every subscription", 'Book seasonal check-ups'],
    ['Learn one new ADHD fact', "Test the smoke alarms", "Start the gift list", "Plan next month's budget"],
...
DAILY = {
    ...
    2: ("Body", [  # Wednesday
        ...
        "Book the checkup you have been putting off.",
    ...
    6: ("Reset", [  # Sunday
        ...
        "Any birthdays or events coming up this month?",
        ...
        "Seasonal reset: swap clothes or gear.",
...
EXPERIMENTS = [
    ...
    ("Default meals", "Pick three no-think meals for busy days.", "Fewer decisions at 6pm."),
    ...
    ("Walk between blocks", "Take a 3-minute walk between focus sessions.", "Moving takes the edge off restlessness."),
    ...
    ("Evening pre-decide", "Choose tonight's plan by 3pm.", "Evenings stop evaporating."),
    ...
    ("Keep the best three", "Pick the three experiments to keep next year.", "Your own playbook, tested."),
]
