# -*- coding: utf-8 -*-
"""Full structural + content verification of v8.19 (v8.18 + fast_paint)."""
import io, os, re, sys
import pikepdf
...
PDF = os.path.join(ROOT, 'output', 'prod1', 'planner_v8.19-undated-FINAL.pdf')
HTML = os.path.join(ROOT, 'src', 'planner_v8.19-undated.html')
# 인자로 다른 판을 재볼 수 있다: python scripts/verify_v8_19.py output/x.pdf src/x.html
if len(sys.argv) == 3:
