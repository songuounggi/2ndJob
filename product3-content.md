...
| 9-2 | **My holidays** | NEW | 12달 칸: 무엇 / 날짜 / 쉬는 날? — 자기 나라 공휴일·방학·휴무. 인쇄 공휴일은 전 세계 공통 5개뿐(§5-2) |
...
| 부분 | 장 |
|---|---|
| 앞부분(표지·사용법·목차·SOS·연간·킥오프·52실험·픽셀·admin·My holidays·생일 2·어디뒀지 + P1 Goals·Project·Vision) | 17 |
| 분기 | 4 |
...
| 2 | ~~공휴일 표시~~ **결정 (2026-09-25): 전 세계 공통만 인쇄 + My holidays 페이지.** | 인쇄: New Year's Day · ADHD Awareness Month(10/1) · World Mental Health Day(10/10) · **Christmas Day**(사용자: "못 참지") · New Year's Eve. 미국 공휴일은 빼고, 자기 나라 날은 `My holidays`(앞부분 10p)에 적는다. 나중에 나라별 공휴일 스티커(5번째 파일)를 검토. 리스팅 문구 후보: "Works anywhere — no country-specific holidays printed". `p3_content.check()` 가 나라별 공휴일이 다시 들어오면 잡는다 |
